### Installation
please refer to the original README below
### Running
```bash
python3 scripts/reconstruct_from_images.py -i <FOLDER_CONTAINING_THE_IMAGES> -o <OUTPUT_FOLDER>
```
Note: currently only pointcloud is available as the output. 
TODO: add texture mapped mesh output

# Original README of SDFStudio
